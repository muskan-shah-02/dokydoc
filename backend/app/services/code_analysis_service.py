...
class CodeAnalysisService:
    @staticmethod
    def analyze_component_in_background(component_id: int) -> None:
        """
        ...
        """
        logger.info(f"Setting up async analysis for component_id: {component_id}")
    ...
    async def _async_analyze_component(component_id: int) -> None:
        ...
        try:
            ...
            logger.info(f"Sending code for component {component_id} to Gemini for analysis...")
            ...
            logger.info(f"Successfully completed and stored analysis for component_id: {component.id}")
