...
from app.api.endpoints import login, dashboard, documents, code_components, document_code_links, analysis_results, validation
...
app.include_router(analysis_results.router, prefix="/api/v1/analysis", tags=["analysis"])
